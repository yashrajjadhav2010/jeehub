...
updates = {
    "nlm-pyq-q11": "April 8, 2024 (I)",
    "nlm-pyq-q12": "April 5, 2024 (I)",
    "nlm-pyq-q13": "April 5, 2024 (II)",
    "nlm-pyq-q14": "Jan. 30, 2024 (I)",
    "nlm-pyq-q15": "Jan. 27, 2024 (I)",
    "nlm-pyq-q16": "April 13, 2023 (I)",
    "nlm-pyq-q17": "April 12, 2023 (I)",
    "nlm-pyq-q18": "April 11, 2023 (I)",
    "nlm-pyq-q19": "April 11, 2023 (II)",
    "nlm-pyq-q20": "April 8, 2023 (I)",
    "nlm-pyq-q21": "Feb. 1, 2024 (II)",
    "nlm-pyq-q22": "Jan. 30, 2023 (II)",
    "nlm-pyq-q23": "Jan. 29, 2023 (II)",
    "nlm-pyq-q24": "July 28, 2022 (I)",
    "nlm-pyq-q25": "July 28, 2022 (I)",
    "nlm-pyq-q1": "April 15, 2023 (I)", 
    "nlm-pyq-q2": "June 24, 2022 (I)",
    "nlm-pyq-q3": "Sep. 2, 2020 (I)",
    "nlm-pyq-q4": "April 13, 2023 (I)",
    "nlm-pyq-q5": "July 29, 2022 (I)",
    "nlm-pyq-q6": "Feb. 1, 2024 (I)",
    "nlm-pyq-q7": "April 13, 2023 (I)",
    "nlm-pyq-q8": "Jan. 25, 2023 (I)",
    "nlm-pyq-q9": "July 26, 2022 (II)",
    "nlm-pyq-q10": "Feb. 24, 2021 (II)"
}

for q_id, date_str in updates.items():
    # Replace the existing (JEE Main YYYY) with the exact date
    # It might be like (JEE Main 2024) or (JEE Main 2023 / 2021)
    pyq = re.sub(
        rf'(id:\s*"{q_id}",\s*question:\s*".*?)\(JEE Main [^\)]+\)"',
        rf'\1(JEE Main {date_str})"',
        pyq,
        flags=re.DOTALL
    )
...
pyq = re.sub(r'\s*\]\s*\};\s*export default pyq;', ',\n' + new_qs + '\n\nexport default pyq;', pyq)
