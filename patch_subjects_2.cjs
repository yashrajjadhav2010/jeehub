...
const target = `        <div className="flex flex-col gap-4 items-end">
          <Link 
            to="/" 
...
const replacement = `        <div className="flex flex-col sm:flex-row gap-4 items-end">
...
console.log('Subjects.tsx patched with Question Bank');
